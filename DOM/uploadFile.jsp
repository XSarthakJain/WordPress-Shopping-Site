...
File ff = new File("C:/Users/Utkarsh/eclipse-workspace/DOS/WebContent/Coching/img/Coching_Banner/"+TutorId);
//File ff1 = new File(");
//ff.mkdir();
 ff = new File("C:/Users/Utkarsh/eclipse-workspace/DOS/WebContent/Coching/img/Coching_Banner/"+saveFile);
String ff1="img/Coching_Banner/"+saveFile;
...
try{
	...
	String sql="Update profile set Banner_Image ='"+ff1+"' where Id='"+TutorId+"' ";
